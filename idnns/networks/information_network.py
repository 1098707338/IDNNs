...
class informationNetwork():
    ...
    # this stores...a lot of networks...this is the meta-class, it does not directly create a network
    # under nn.train_and_calc_inf_network(), it calls method nn.train_network() where it initializes
    # a fresh network and train it.
    ...
    def save_data(self, parent_dir='jobs/', file_to_save='data.pickle'):
        ...
        # this is how the pickle file is saved...
    ...
    def run_network(self):
        ...
        if self.run_in_parallel:
            ...
            # by default layer-size is: [[10, 7, 5, 4, 3]]

        # Extract all the measures and orgainze it
        # we can just append the value we are looking for in here! The Norm!
        for i in range(len(self.train_samples)):
            for j in range(len(self.layers_sizes)):  # this is just [[10, 7, 5, ...]]
                for k in range(self.num_of_repeats):
                    ...
                    self.weights_l2_norm[k][j][i] = current_network['weights_l2_norm']
                    ...
                    # TODO: L1 / L2 are not even here...
                    # TODO: weights are 0...even though it's "extracted" here, MUST correctly load weights
                    # TODO: same, train_error, test_error, loss_train, loss_test are all 0. (maybe only used for MNIST?)
