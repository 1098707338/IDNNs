...
def get_default_parser(num_of_samples=None):
    ...
    # we can show that dropout
    parser.add_argument('-dropout',
                        '-d', dest="dropout", type=float, default=0.,
                        help='if we choose to do dropout amongst layers')
    ...
    parser.add_argument('-num_epochs',
                        '-e', dest="num_ephocs", default=8000,  # 4000 is enough by the paper, here the default is 8000
    ...
    # omg...really!? the output of layers!? isn't this what I'm looking for? activation norm?
    ...
    parser.add_argument('-save_grads',
                        ...
                        help='if we want to save the gradients in the network')  # use to be False...this saves weights as well!
